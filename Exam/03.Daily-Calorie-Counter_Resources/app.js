function solve (){
    ...
    const {addBtn, editBtn, loadBtn, mealsContainer, wrapper } = otherDOMElements;
    ...
    function loadsMeals(){
            ...
            .then((data) => {
                ...
                for (const key in data) {
                    ...
                    const div = createElement("div", mealsContainer, null, [
                      "meal",
                    ]);
                    div.id = data[key]._id;
                    ...
                    changeBtn.addEventListener('click', chamgeMeal);
